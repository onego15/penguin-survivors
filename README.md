...
**2キャラ・2ステージ・23武器・3匹のサポート**。キャラクターと背景はPrimitive Meshで構成し、BGM・効果音も同梱しています。外部アセット・プラグイン・Blenderは不要です。
...
本編は共通9種＋限定7種の**各16種類**。極光プリズムは両ステージ共通です。雪原では常時周回する「真珠のまもり」、城では長い待ち時間の後に巨大な星を落とす「おほしさまメテオ」を使えます。タイトルの一覧ボタンで所属を確認でき、サンドボックスでは全23種類を利用できます。

![常時周回する真珠](docs/screenshots/six-pearls.png)
