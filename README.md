...
通常戦闘・サポートの同行・必殺技から、ラスボス登場、第二形態の大氷震、祝勝画面までを紹介します。最新の必殺技と満タン通知を収録しています。上のプレビューは冒頭8秒・30fps・音声なしです。滑らかな60fpsの本編はMP4リンクから再生できます。
...
クリックまたは左右キーで「メガネペンギン」「ピンクペンギン」を選べます。同一起動中は選択を保持し、再挑戦も同じキャラクターです。
