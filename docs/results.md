...
クリアと死亡の両方で、右側に「今回の活躍」を表示します。祝勝ステージのキャラクターはそのまま残し、死亡時は到達Wave・時間・レベル・撃破数と一緒に振り返れます。
...
![祝勝画面の貢献一覧](screenshots/contributions-victory.png)
![死亡時の貢献一覧](screenshots/contributions-defeat.png)
![制御の成功回数で並べ替え](screenshots/contributions-control.png)
