...
本編は共通9種＋限定7種の各16種類から、新規取得と強化を混ぜて抽選します。**極光プリズムは両ステージ共通**。キャラの初期装備も共通枠です。16種類すべてLv.5ならレベルアップでHP20回復。サンドボックスでは所属に関係なく全23種類を試せます。

共通：極光プリズム、氷ブラスター、ハートの波動、羽根ショット、氷河のチャイム、おさかなブーメラン、ちゅるちゅるおうどん、ぱたぱた扇風機、ひえひえアイスキャンディ。
