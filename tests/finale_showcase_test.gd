...
func run() -> void:
	...
	check(game.victory and is_instance_valid(game.victory_screen) and game.victory_screen.characters.size()==2 and game.victory_screen.friends.has(1),"Victory shows penguin and only the recruited bear")
