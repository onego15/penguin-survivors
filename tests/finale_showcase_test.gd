...
func run() -> void:
	...
	check(game.victory_screen.results.weapons.size()==18 and not is_instance_valid(game.support.active),"Victory carries all weapon results and clears combat support")
